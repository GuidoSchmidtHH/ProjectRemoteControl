...
public class RaspiStillWrapper 
{
	  ...
	  // Define the path to the raspistill executable.
	   ...
	   public void TakePicture()
	   {
	      try
	      {
	         ...
	         //sb.append(" -n -bm"); // w/o preview
	         sb.append(" -bm"); // with preview
	         ...
	         System.out.println("RaspiStill Parms: " + sb.toString() );  
	...
	public static void main(String[] args) 
	{
		// TODO Auto-generated method stub
		 ...
		 // Define the number of photos to take.
		  long _numberOfImages = 1;
		  // Define the interval between photos.
		  int _delayInterval = 5000;
		
		try
	    {
	      // Create a new RaspiStill object.
	      RaspiStillWrapper camera = new RaspiStillWrapper();

...
public class PCA9685Servo 
{
	...
	private int  ServoValueSpeed = 0; 
	private int  ServoValueRad = 0; 
	...
	// -----------------------------------------------------------------
	// Get Servo Value -100 ... 100
	// -----------------------------------------------------------------
	public int GetServoValueSpeed()
	{

		// getPWM abfragen
		// LEDValue setzen

		return ServoValueSpeed;

	}

	// -----------------------------------------------------------------
	// Get Servo Value -90 ... 90
	// -----------------------------------------------------------------
	public int GetServoValueRad()
	{

		// getPWM abfragen
		// LEDValue setzen

		return ServoValueRad;
